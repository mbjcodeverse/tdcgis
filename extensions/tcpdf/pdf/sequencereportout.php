...
public function getReportPrinting(){
  ...
  $trans_title = "STOCK-OUT TRANSACTION SEQUENCE";
  ...
  <table>
    ...
    <tr>
        ...
        <td style="border: 1px solid #666;width:75px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;DR #</td>
        
        <td style="border: 1px solid #666;width:165px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;Stakeholder</td>                   

        <td style="border: 1px solid #666;width:185px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;Products</td>
  ...
  foreach ($recordset as $key => $value) {
    ...
    if ($value["pdesc"] != null){
      ...
      <table style="border: none;">    
        ...
        <td style="width:75px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;$recnumber</td> 

        <td style="width:165px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;$stkname</td>              

        <td style="width:185px;text-align:left;font-size:11px;">&nbsp;&nbsp;&nbsp;$pdesc</td>
