...
class printTallySheet{

public $invno;
public function getTallySheetPrinting(){
  $itemSales = "invno";
  $invSales = $this->invno;
  ...
  $header = <<<EOF
    <table>
      ...
      <tr>
        <td style="width:540px;text-align:center;font-size:1.2em;font-weight:bold;">Sales Tally Sheet</td> 
      </tr>
  ...
  $footer = <<<EOF
        ...
        <tr>
	      ...
	      <tr>
	        ...
	        <td style="width:110px;text-align: right;font-size:11px;">Prepared by:</td>
          <td style="width:175px;text-align: right;font-size:11px;">Checked by:</td>          
	      </tr>
	      <tr>
	        <td style="width:330px;font-size:11px;"></td>	      
	      </tr>
...
EOF;
  ...
  $pdf->Output('tallysheet.pdf', 'I');
 }
}

$salesTallyForm = new printTallySheet();
$salesTallyForm -> invno = $_GET["invno"];
$salesTallyForm -> getTallySheetPrinting();
?>