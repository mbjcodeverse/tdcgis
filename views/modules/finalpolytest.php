...
<div class="map-container" id="map" style="height:100%"></div>
      ...
      <!-- <svg id="mySVG" width="200" height="200">
          <polygon id="myPolygon" points="100,10 40,180 190,60 10,60 160,180" fill="blue" />
      </svg> -->
...
<!-- <script type="module" src="views/js/finalpolytest.js"></script> -->
...
<!-- AIzaSyBc6JpeMq16j7_-n9dgCTGWpd8Qh8waYvU -->