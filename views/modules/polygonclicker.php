...
<!-- <svg width="600" height="400" id="mySVG">
        <polygon points="100,10 200,10 150,110" class="overlay" id="myPolygon"/>
    </svg>
...
<script type="module" src="views/js/polygonclicker.js"></script>
