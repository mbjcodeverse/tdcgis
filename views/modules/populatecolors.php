<div class="map-container" id="map" style="height:100%"></div>
      <ul class="navbar-nav" style="width:3rem;position:absolute;top: 58px;right:5px;left: inherit;">
        ...
        <button type="button" style="margin-bottom:3px;" class="btn bg-info btn-icon ml-2" id="btn-search" data-toggle="modal" data-target="#modal-search-sales"><i class="icon-search4"></i></button>
