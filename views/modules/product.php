    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-2 form-group">
                <label for="tns-barcode">Bar Code</label>
                <input type="text" class="form-control" id="tns-barcode" name="tns-barcode" autocomplete="nope">
            </div>            
         ...
         <div class="row">          
            ...
            <div class="col-sm-2 form-group">
              <label for="sel-meas1">( Selling Unit )</label>
            ...
            <div class="col-sm-2 form-group">
                ...
                <input type="text" class="form-control numeric hide-cursor" id="num-eqnum" name="num-eqnum" value="1.00" autocomplete="nope">
            </div>  

            <div class="col-sm-2 form-group">
              <label for="sel-meas2" id="lbl-sel-meas2" style="color:aqua;">= &gt; SKU</label>
              <select data-placeholder="< Select SKU >" class="form-control select-search" id="sel-meas2" name="sel-meas2">
                <option></option>
                <?php
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;PRODUCT MASTER LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: 0px;">
            ...
            <div class="col-sm-3 form-group">
              <label for="lst-brandcode" id="lbl-lst-brandcode" style="color:aqua;">= &gt; Brand</label>
               <select data-placeholder="< Select Brand >" class="form-control select-search" id="lst-brandcode" name="lst-brandcode">
                <option></option>
                <?php
                    $brands = (new ControllerBrand)->ctrShowBrandList();
                    foreach ($brands as $key => $value) {
            ...
            <div class="col-sm-2 form-group">
              <label for="lst-accountcode" id="lbl-lst-accountcode" style="color:aqua;">= &gt; Prod Account</label>
              <select data-placeholder="< Select Accnt >" class="form-control select-search" id="lst-accountcode" name="lst-accountcode">
                <option></option>
                <?php
                    $account = (new ControllerProdaccount)->ctrShowProdaccountList();
                    foreach ($account as $key => $value) {
                      echo '<option value="'.$value["accountcode"].'">'.$value["accountdesc"].'</option>';
                    }
                 ?>
              </select>  
            </div>
            ...
            <div class="col-sm-2 form-group">
              <label for="lst-meas1" id="lbl-lst-meas1" style="color:aqua;">= &gt; ( Selling Unit )</label>
              <select data-placeholder="< Select SKU >" class="form-control select-search" id="lst-meas1" name="lst-meas1" required>
                <option></option>
                <?php
                    $meas_1 = (new ControllerMeasure)->ctrShowAllMeasure();
                    foreach ($meas_1 as $key => $value) {
                      echo '<option value="'.$value["mdesc"].'">'.$value["mexpound"].'</option>';
                    }
                 ?>
              </select>  
            ...
            <div class="col-sm-2 form-group">
              ...
              <select data-placeholder="< Select Desc >" class="form-control select" data-fouc id="lst-vatdesc" name="lst-vatdesc" required>
                <option></option>
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header productTable">

          <thead>
            <tr>
              <th style="min-width: 370px;">Product Name</th>
              <th style="min-width: 187px;">Category</th>
              <th style="min-width: 118px;">Unit Cost</th>
              <th style="min-width: 118px;">Mark-up</th>
              <th style="min-width: 118px;">Unit Price</th>
