...
<div class="container-fluid">
  <form class="return-form" method="POST" autocomplete="nope">
    <div class="row">
      <div class="col-md-7" style="padding-left: 12px;margin-top: 13px;">
        <div class="card h-95">
          <div class="card-header d-flex bg-transparent border-bottom" style="padding-top: 12px;padding-right: 1px;padding-bottom:10px;">
            <h4 class="card-title flex-grow-1 transaction-name">ITEM RETURN</h4>
              <!-- EMP ID -->
          ...
          <div class="card-body" style="padding-bottom: 0;margin-bottom: 0;">
              ...
              <!-- <div class="row"> -->
                <div class="col-sm-5 form-group" style="padding: 0;">
                    <select data-placeholder="< Return by >" class="form-control select-search" id="sel-returnby" name="sel-returnby" required>
                      <option></option>
                      <?php
                        $item = null;
                        $value = null;
                ...
                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;padding-left: 7px;">
                  <input type="text" class="form-control datepicker" data-mask="99/99/9999" placeholder="Pick a date&hellip;" id="date-retdate" name="date-retdate" required>
                </div>    

                <div class="col-sm-2 form-group" style="padding: 0px;padding-right: 7px;">
                    <input type="text" class="form-control transaction-status" id="txt-retstatus" name="txt-retstatus" value="Posted" autocomplete="nope" required readonly="true">
                </div>                          
             
                <div class="col-sm-3 form-group" style="padding: 0px;">
                    <div class="input-group">
                    <input type="text" class="form-control transaction-id" id="txt-retnumber" name="txt-retnumber" placeholder="Return #" autocomplete="nope" required readonly="true">
                    </div>
                </div>
          ...
          <div class="card-footer" style="padding-top: 0;margin-top: 0;">
            ...
            <div class="btn-group btn-group-justified" style="margin-top: 10px;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-light" id="btn-search" data-toggle="modal" data-target="#modal-search-return"><i class="icon-file-text2"></i>&nbsp;&nbsp;Search</button>
              </div>
...
<!-- ============== Return List ============ -->
<div id="modal-search-return" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" style="background-color: #343f53;">
      <div class="modal-header">
        <h5 class="modal-title profile-name"><i class="icon-menu7 mr-2"></i> &nbsp;ITEM RETURN LIST</h5>
      ...
      <div class="h-divider">
          ...
          <div class="row" pb-0 style="margin:10px;margin-bottom: 0px;">
            <div class="col-sm-4 form-group">
              <label for="lst-empid" id="lbl-lst-empid" style="color:aqua;">= &gt; Returnee</label>
              <select data-placeholder="< Select Returnee >" class="form-control select-search" id="lst-empid" name="lst-empid">
                  <option></option>
                  <?php
                    $item = null;
                    $value = null;
          ...
          <table class="table table-hover table-bordered table-striped datatable-small-font profile-grid-header returnTransactionTable">
          <thead>
            <tr>
